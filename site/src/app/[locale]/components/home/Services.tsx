...
const Services = () => {
  ...
  return (
    ...
    >
      <div className="col-span-3 p-8 max-lg:col-span-4 max-lg:border max-lg:border-b-2">
        <h2 className="font-black mb-6 text-elcar text-[34px] tracking-[0.25px] dark:text-primary-foreground">
          {t("main.title")}
        </h2>
        <div
          className="text-gray-600 max-w-4xl  text-sm tracking-normal leading-6 mb-4 dark:text-secondary-foreground"
